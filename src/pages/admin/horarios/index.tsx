                    ...
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-3 h-3 rounded-full ${
                          day.falseOrTrue ? "bg-green-500" : "bg-red-500"
                        }`}
                      />
                      <span
                        className={`text-lg font-medium ${
                          day.falseOrTrue ? "text-white" : "text-white/50"
                        }`}
                      >
                        {dayNameMap[day.diaDaSemana]}
                      </span>
                      <span className="px-2 py-0.5 bg-neutral-800 rounded-full text-white/60 text-xs">
                        {day.hours.length} horário
                        {day.hours.length !== 1 ? "s" : ""}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        title={day.falseOrTrue ? "Desativar dia" : "Ativar dia"}
                      >
